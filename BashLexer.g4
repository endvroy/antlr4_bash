...
HEAD_EQ : '=' -> type(PROGNAME), mode(NO_ASSIGN);
...
mode NECK;
NECK_PROGNAME : PROGNAME -> type(PROGNAME);
...
mode BT;
BT_BLANK : BLANK -> skip;
BT_PROGNAME : PROGNAME -> type(PROGNAME), mode(NECK);
BT_HEAD_EQ : EQ -> type(PROGNAME), mode(NO_ASSIGN);
BT_VAR : VAR -> type(VAR), mode(NO_ASSIGN);
BT_SQUOTE_STR : SQUOTE_STR -> type(SQUOTE_STR), mode(NO_ASSIGN) ;
BT_DQUOTE : DQUOTE -> type(DQUOTE), mode(NO_ASSIGN), pushMode(INSIDE_DQUOTE) ;
BT_DOLLAR_LPAREN : DOLLAR_LPAREN -> type(DOLLAR_LPAREN), mode(NO_ASSIGN), pushMode(DEFAULT_MODE);
BT_LT_LPAREN : LT_LPAREN -> type(LT_LPAREN), mode(NO_ASSIGN), pushMode(DEFAULT_MODE);
BT_GT_LPAREN : GT_LPAREN -> type(GT_LPAREN), mode(NO_ASSIGN), pushMode(DEFAULT_MODE);
BT_BACKTICK : BACKTICK -> type(BACKTICK), popMode;
BT_RPAREN : RPAREN -> type(RPAREN), popMode;

mode BT_NECK;
BT_NECK_PROGNAME : PROGNAME -> type(PROGNAME);
BT_NECK_BLANK : BLANK -> skip, mode(ARGS);
BT_EQ : HEAD_EQ -> mode(ASSIGN_RLS);
BT_NECK_VAR : VAR -> type(VAR), mode(NO_ASSIGN);
BT_NECK_SQUOTE_STR : SQUOTE_STR -> type(SQUOTE_STR), mode(NO_ASSIGN) ;
BT_NECK_DQUOTE : DQUOTE -> type(DQUOTE), mode(NO_ASSIGN), pushMode(INSIDE_DQUOTE) ;
BT_NECK_DOLLAR_LPAREN : DOLLAR_LPAREN -> type(DOLLAR_LPAREN), mode(NO_ASSIGN), pushMode(DEFAULT_MODE);
BT_NECK_LT_LPAREN : LT_LPAREN -> type(LT_LPAREN), mode(NO_ASSIGN), pushMode(DEFAULT_MODE);
BT_NECK_GT_LPAREN : GT_LPAREN -> type(GT_LPAREN), mode(NO_ASSIGN), pushMode(DEFAULT_MODE);
BT_NECK_BACKTICK : BACKTICK -> type(BACKTICK), popMode;
BT_NECK_RPAREN : RPAREN -> type(RPAREN), popMode;

mode BT_NO_ASSIGN;
BT_NAME : NAME -> type(PROGNAME);
BT_NO_ASSIGN_BLANK : BLANK -> skip, mode(ARGS);
...
BT_NO_ASSIGN_DOLLAR_LPAREN : DOLLAR_LPAREN -> type(DOLLAR_LPAREN), pushMode(DEFAULT_MODE);
BT_NO_ASSIGN_LT_LPAREN : LT_LPAREN -> type(LT_LPAREN), pushMode(DEFAULT_MODE);
BT_NO_ASSIGN_GT_LPAREN : GT_LPAREN -> type(GT_LPAREN),  pushMode(DEFAULT_MODE);
BT_NO_ASSIGN_BACKTICK : BACKTICK -> type(BACKTICK), popMode;
BT_NO_ASSIGN_RPAREN : RPAREN -> type(RPAREN), popMode;

mode BT_ARGS;
BT_ARG: ARG;
BT_ARGS_SQUOTE_STR : SQUOTE_STR ;
BT_ARGS_VAR : VAR;
BT_ARGS_DOLLAR_LPAREN : DOLLAR_LPAREN -> type(DOLLAR_LPAREN), pushMode(DEFAULT_MODE);
BT_ARGS_LT_LPAREN : LT_LPAREN ->type(LT_LPAREN), pushMode(DEFAULT_MODE);
BT_ARGS_GT_LPAREN : GT_LPAREN ->type(GT_LPAREN), pushMode(DEFAULT_MODE);
BT_ARGS_DQUOTE : DQUOTE ->type(DQUOTE), pushMode(INSIDE_DQUOTE);
BT_ARGS_BLANK : BLANK;
BT_PIPE : PIPE -> mode(DEFAULT_MODE);
BT_ARGS_BACKTICK : BACKTICK ->type(BACKTICK), popMode;
BT_ARGS_RPAREN: RPAREN -> type(RPAREN), popMode;

mode BT_ASSIGN_RLS;
BT_LITERAL: LITERAL;
BT_RLS_SQUOTE_STR : SQUOTE_STR ;
BT_RLS_VAR : VAR;
BT_RLS_DOLLAR_LPAREN : DOLLAR_LPAREN -> type(DOLLAR_LPAREN), pushMode(DEFAULT_MODE);
...
BT_RLS_BLANK: BLANK -> mode(DEFAULT_MODE);
